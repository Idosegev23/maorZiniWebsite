  ...
  const faqItems = [
    {
      ...
      content: 'בפגישה אישית נבחן את המצב הנוכחי שלך, הצרכים, היעדים והתקציב. לאחר ניתוח מקיף נוכל להמליץ על סוגי הביטוח המתאימים ביותר עבורך.',
    },
    {
  ...
  return (
    <section className="bg-white py-16 md:py-24 relative">
      ...
      <div className="container">
        <SectionTitle
          title="שאלות נפוצות"
          subtitle="מענה לשאלות שעולות בתהליך ההיכרות מולי"
          center
          showUnderline
          boldSubtitle
        />
