  ...
  return (
    <>
      <button 
        ...
        className="
          fixed z-50 
          md:top-1/2 md:-translate-y-1/2 md:right-5 md:rounded-xl
          sm:bottom-20 sm:right-5 sm:left-auto sm:rounded-xl
          bottom-0 right-0 left-0 rounded-none
          flex items-center justify-center gap-2 
          sm:py-3 sm:px-4 md:px-6 py-3
          bg-brandBlue text-white shadow-lg hover:bg-opacity-90 transition-colors"
        aria-label="רכישת ביטוח חו״ל"
      >
        <Plane size={20} className="text-brandGold" />
        <span className="text-sm md:text-base font-medium">לרכישת ביטוח נסיעות בקליק</span>
      </button>
