  ...
  return (
    <>
      <button 
        ...
        className="
          fixed z-50 
          md:top-1/2 md:-translate-y-1/2 md:right-5 md:rounded-xl md:px-8 md:py-4
      ...
      >
        <Plane className="text-brandGold w-5 h-5 md:w-6 md:h-6" />
        <span className="text-sm md:text-lg font-medium">לרכישת ביטוח נסיעות בקליק</span>
      </button>
