...
export const metadata: Metadata = {
  ...
  description: 'ראיון עם מאור על ייעוץ אישי, תובנות מהשטח ודגשים חשובים.',
};
...
export default function MaorInterviewPage() {
      ...
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-lg text-brandGray mb-8">
            ראיון עם מאור על ייעוץ אישי, תובנות מהשטח ודגשים חשובים.
          </p>
        </div>
  ...
  <h2>על ייעוץ אישי מול משווקי ביטוח</h2>
