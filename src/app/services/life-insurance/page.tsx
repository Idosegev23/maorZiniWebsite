        ...
        <div className="container">
          ...
          <div className="max-w-4xl mx-auto mt-12">
            ...
            <div className="mt-12 bg-white rounded-2xl p-8 shadow-md">
              ...
              <p>בתהליך התכנון נבצע יחד ניתוח צרכים ונמצא את הפוליסה המתאימה ביותר – בלי למכור חלומות, אלא לבנות ביטחון.</p>
              
              <h2 className="text-2xl font-bold text-brandBlue mt-10 mb-6">למה לבחור בליווי אישי?</h2>
              <ul className="list-disc list-inside space-y-2 mr-4 mt-6">
                <li>שירות בגובה העיניים – כל האפשרויות מוסברות בצורה פשוטה, ללא אותיות קטנות מבלבלות.</li>
                <li>ליווי לאורך זמן – לא רק ביום הרכישה, אלא גם שנים קדימה.</li>
                <li>התאמה לצרכים שמשתנים – עם השנים הצרכים משתנים, וחשוב שגם הביטוח יתאים את עצמו.</li>
              </ul>
            </div>
