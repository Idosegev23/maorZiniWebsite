...
export const metadata = {
  ...
  description: 'קופת גמל להשקעה היא מוצר חיסכון גמיש עם נזילות מלאה, הפקדות עד 76,000₪ בשנה, והטבות מס משמעותיות למושכים כקצבה.',
};
          ...
          <div className="max-w-4xl mx-auto mt-12">
            ...
            <div className="mt-12 bg-white rounded-2xl p-8 shadow-md">
              ...
              <ul className="list-disc list-inside space-y-2 mr-4 mb-8">
                <li>הפקדה של עד 76,000 ₪ בשנה (לכל אזרח מגיל 0)</li>
